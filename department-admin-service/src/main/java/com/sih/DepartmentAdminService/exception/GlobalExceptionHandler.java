package com.sih.DepartmentAdminService.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(InvalidInputException e, HttpServletRequest request) {
        log.error("InvalidInputException handled with message: {}", e.getMessage());
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<ErrorResponse> handleException(ForbiddenAccessException e, HttpServletRequest request) {
        log.error("ForbiddenAccessException handled with message: {}", e.getMessage());
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
