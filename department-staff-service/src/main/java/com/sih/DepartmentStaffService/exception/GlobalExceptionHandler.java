package com.sih.DepartmentStaffService.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleForbiddenAccessException(ForbiddenAccessException e, HttpServletRequest request) {
